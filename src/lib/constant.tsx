...
export const alignMenuItems: AlignMenuItem[] = [
    ...
    {
        name: "Center Align",
        icon: <FormatAlignCenterIcon sx = {{width : '20px'}}/>,
        payload: "center",
    },
    {
        name: "Right Align",
        icon: <FormatAlignRightIcon sx = {{width : '20px'}}/>,
        payload: "right",
    },
    {
        name: "Justify Align",
        icon: <FormatAlignJustifyIcon sx = {{width : '20px'}}/>,
        payload: "justify",
    }
];
...
export const TextFormats: FormatTextMenuItem[] = [
    {
        name: "Strikethrough",
        icon: <StrikethroughSIcon />,
        payload: "strikethrough",
