...
function FontDropDown({
  ...
  const normalizeClassName = (fontName: string) =>
    fontName.replace(/\s+/g, "-").toLowerCase();
  console.log("normalize", normalizeClassName);
  return (
    <DropDown
      disabled={disabled}
      ...
      {(style === "font-family" ? FONT_FAMILY_OPTIONS : FONT_SIZE_OPTIONS).map(
        ([option, text]) => (
          <DropDownItem
            ...
            } font-${normalizeClassName(option)} `}
      ...
      {blockType === "code" ? (
        ...
        <>
          ...
          <Icons
            ...
            isActive={isBold}
          >
            <LightTooltip title="Bold (Ctrl+B)">
              <FormatBoldIcon sx={{ width: "20px", height: "20px" }} />
            </LightTooltip>
          </Icons>
          <Icons
            isEditable={isEditable}
            ...
            isActive={isItalic}
          >
            <LightTooltip title="Italic (Ctrl+I)">
              <FormatItalicIcon sx={{ width: "20px", height: "20px" }} />
            </LightTooltip>
          </Icons>
          <Icons
            isEditable={isEditable}
          ...
          >
            <LightTooltip title="Underline (Ctrl+U))">
              <FormatUnderlinedIcon sx={{ width: "20px", height: "20px" }} />
            </LightTooltip>
          </Icons>
          ...
          <Icons isEditable={isEditable} onClick={insertLink} isActive={isLink}>
            <LightTooltip title="Insert link">
